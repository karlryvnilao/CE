...
// update module
$(document).on("submit","#updateModuleFrm" , function(){
  $.post("query/updateModuleExe.php", $(this).serialize() , function(data){
     if(data.res == "success")
     {
        Swal.fire(
            'Success',
            data.mdl_title   + ' <br>has been successfully updated!',
            'success'
          )
          refreshDiv();
     }
...
//update task
$(document).on("submit","#updateTaskFrm" , function(){
  $.post("query/updateTaskExe.php", $(this).serialize() , function(data){
     if(data.res == "success")
     {
        Swal.fire(
            'Success',
...
//update usertask
$(document).on("submit","#updateUsertaskFrm" , function(){
  $.post("query/updateUserTaskExe.php", $(this).serialize() , function(data){
     if(data.res == "success")
     {
        Swal.fire(
            'Success',
            data.utSubmit   + ' <br>has been successfully updated!',
            'success'
          )
          refreshDiv();
     }
