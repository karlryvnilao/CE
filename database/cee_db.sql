...
INSERT INTO `task_tbl` (`task_id`, `task_title`, `task_SDate`, `task_EDate`, `task_desc`, `date_created`) VALUES
(1, 'Test', '2023-12-16', '2023-12-17', 'Test', '2023-12-16 14:38:45');

-- --------------------------------------------------------

--
-- Table structure for table `usertask_tbl`
--

CREATE TABLE `usertask_tbl` (
  `usertask_id` int(11) NOT NULL,
  `task_id` int(11) NOT NULL,
  `usertask_answer` text NOT NULL,
  `exmne_fullname` varchar(255) NOT NULL,
  `usertask_submit` varchar(255) NOT NULL,
  `usertask_score` varchar(255) NOT NULL,
  `usertask_grade` varchar(255) NOT NULL,
  `usertask_date` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `usertask_tbl`
--
...
--
-- Indexes for table `usertask_tbl`
--
...
--
ALTER TABLE `module_tbl`
  MODIFY `mdl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
